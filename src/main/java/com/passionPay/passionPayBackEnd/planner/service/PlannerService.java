...
import com.passionPay.passionPayBackEnd.subject.dto.SubjectTaskDto;
import com.passionPay.passionPayBackEnd.task.dto.TaskDto;
import com.passionPay.passionPayBackEnd.member.dto.ProfileDto;
...
import com.passionPay.passionPayBackEnd.timestamp.repository.TimestampRepository;
...
public class PlannerService {
    ...
    @Transactional
    public Planner updatePlanner(CreatePlannerPayload createPlannerPayload, Planner planner) {
        // comment
        planner.setComment(createPlannerPayload.getComment());
        // d-day
        planner.setDDay(DateUtil.parseStringToDate(createPlannerPayload.getDDay()));
        // expected study time
        planner.setExpectedStudyTime(DateUtil.parseStringToTime(createPlannerPayload.getExpectedStudyTime()));
        // current study time
        planner.setCurrentStudyTime(DateUtil.parseStringToTime(createPlannerPayload.getCurrentStudyTime()));
        // evaluation
        planner.setComment(createPlannerPayload.getComment());
        return plannerRepository.save(planner);
    }
